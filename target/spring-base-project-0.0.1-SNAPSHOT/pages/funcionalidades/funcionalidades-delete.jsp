                ...
                <form:form method="POST" modelAttribute="f" name="f" action="funcionalidades-delete">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <h5 style="margin-top: 2rem;">
                                CONFIRMA EXCLUS�O DO BRECHO: <span
                                    style="text-transform: uppercase; font-weight: bold; color: red;">${f.nome}</span>?
                            </h5>
                            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-8 mt-5">
                            <form:errors path="nome" cssClass="text-danger align-middle"
                                         cssStyle="text-transform: uppercase;font-weight: bold;"/>
                        </div>
                    </div>
                </form:form>
